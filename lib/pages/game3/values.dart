  ...
  Tetromino.J: Color.fromARGB(255, 0, 102, 255), // Blue Tetromino.I: Color.fromARGB(255, 242, 0, 255), // Pink
  Tetromino.I: Color.fromARGB(255, 242, 0, 255),
  Tetromino.O: Color (0xFFFFFF00), // Yellow Tetromino.S: Color (0xFF008000), // Green
